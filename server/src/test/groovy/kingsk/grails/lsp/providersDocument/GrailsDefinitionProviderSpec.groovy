...
class GrailsDefinitionProviderSpec extends DefinitionTestSpec {
    ...
    def "should resolve local variable definition from declaration"() {
        ...
        String content = """class Definitions {
  public Definitions() {
    int localVar
  }
}"""
        String uri = openTextDocument("Definitions.groovy", content)
        ...
        locations.size() == 1
        assertLocation(locations[0], uri, 2, 4, 2, 7)
    }
  ...
  public Definitions() {
    ...
    localVar.charAt(0)
        ...
        then:
        locations.size() == 1
        assertLocation(locations[0], uri, 2, 4, 2, 10)
    }
  ...
  public Definitions() {
    memberVar = 123
        ...
        then:
        locations.size() == 1
        assertLocation(locations[0], uri, 1, 9, 1, 12)
    }
    ...
    def "should resolve parameter definition from reference"() {
        ...
        then:
        locations.size() == 1
        assertLocation(locations[0], uri, 1, 27, 1, 30)
    }
