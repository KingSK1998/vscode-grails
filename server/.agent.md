...
> **After EVERY task that touches server code, update `server/STATUS.md`.**
...
### LSP Capabilities
- **Implemented**: Completion, Hover, Definition, Implementation, References, Symbols, Diagnostics, Signature Help, Code Lens, Inlay Hints, Rename (best-effort; `renameProvider` on)
- **Stub / empty**: Code actions (`textDocument/codeAction` returns no items)
- **Future**: Document Highlighting, Semantic Tokens, Formatting, Folding, pull diagnostics registration, prepare rename polish
